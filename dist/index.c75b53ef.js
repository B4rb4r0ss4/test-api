...
})({"5LrAc":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "319e4ebb6315a05ecf4e9a8ec75b53ef";
// @flow
...
},{"./app":"4Z9jT","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4Z9jT":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _baseBase = require('./base/base');
var _baseBaseDefault = _parcelHelpers.interopDefault(_baseBase);
...
var _modelQuestions = require('./model/questions');
var _modelQuestionsDefault = _parcelHelpers.interopDefault(_modelQuestions);
var _viewQuestionView = require('./view/questionView');
var _controlersAnswers = require('./controlers/answers');
const play = async () => {
  await _modelQuestionsDefault.default('pytania2021', _baseBaseDefault.default.apiKey).then(data => {
    _baseBaseDefault.default.questions.push(...data);
    _controlersPureFunctionsDefault.default(_baseBaseDefault.default.questions);
    _baseBaseDefault.default.question = _baseBaseDefault.default.questions[_baseBaseDefault.default.currentQuestion];
  }).catch(e => {
    console.log(e);
  });
  const numberOfAllQuestions = _baseBaseDefault.default.questions.length;
  if (numberOfAllQuestions > 0 && _baseBaseDefault.default.currentQuestion !== numberOfAllQuestions - 1) {
    _viewQuestionView.displayQuestion();
    _controlersAnswers.addAnswersFunctions(_baseQuerySelectorsDefault.default.answers, _baseBaseDefault.default.questions[_baseBaseDefault.default.currentQuestion]._id, _baseBaseDefault.default.apiKey);
  } else return points;
};
exports.default = play;

},{"./controlers/pureFunctions":"6ZtnW","./model/questions":"rdiL5","./controlers/answers":"5tWxC","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","./view/questionView":"cvJSW","./base/base":"3rpAc","./base/querySelectors":"5nebU"}],"6ZtnW":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{}],"rdiL5":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{}],"5tWxC":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
var _baseBase = require('../base/base');
var _baseBaseDefault = _parcelHelpers.interopDefault(_baseBase);
const addAnswersFunctions = (answers, questionId, apiKey) => {
  let result;
  answers.forEach(answer => {
    answer.addEventListener('click', async () => {
      if (answer.classList.contains('click')) {
        try {
          const {data} = await _modelAnswer.getAnswer(answer.id, 'pytania2021', questionId, apiKey);
          _viewAnswersView.displayAnswer('pytania2021', data.result, questionId, apiKey, answer, answers);
          _baseBaseDefault.default.currentQuestion++;
          console.log(_baseBaseDefault.default);
          document.querySelector('.status').addEventListener('click', _viewQuestionView.displayQuestion);
        } catch (e) {
          alert(e);
        }
      }
...
},{"../model/answer":"5N28H","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","../view/answersView":"4gXWL","../view/questionView":"cvJSW","../base/base":"3rpAc"}],"5N28H":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
var _axios = require('axios');
var _axiosDefault = _parcelHelpers.interopDefault(_axios);
const getAnswer = async (answer, questionSet, id, apiKey) => {
  const data = await _axiosDefault.default.get(`/checkAnswer/${questionSet}/${id}/${answer}/${apiKey}`);
  return data;
};

},{"axios":"7rA65","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4gXWL":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
const displayAnswer = async (questionSet, result, questionId, apiKey, answer, answers) => {
  try {
    if (result) {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","../model/getCorrectAnswer":"6Bzrk","./questionView":"cvJSW"}],"6Bzrk":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./answer":"5N28H","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"cvJSW":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
const displayQuestion = async () => {
  const {status, title, output, answers} = _baseQuerySelectorsDefault.default;
  const questionNumber = _baseBaseDefault.default.currentQuestion;
  const numberOfAllQuestions = _baseBaseDefault.default.questions.length;
  const {a, b, c, d, Question} = _baseBaseDefault.default.question;
  ...
  answers.forEach((el, i) => {
    ...
    el.id = Object.keys(_baseBaseDefault.default.question).find(key => _baseBaseDefault.default.question[key] === answersArray[i]);
  });
  output.textContent = `${questionNumber}/${numberOfAllQuestions}`;
  removeCorrectAndWrongAnswer(answers);
  switchCSSClass(answers, 'click');
};

},{"../controlers/pureFunctions":"6ZtnW","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","../base/base":"3rpAc","../base/querySelectors":"5nebU"}],"3rpAc":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
const appVariables = {
  currentQuestion: 0,
...
//# sourceMappingURL=index.c75b53ef.js.map
